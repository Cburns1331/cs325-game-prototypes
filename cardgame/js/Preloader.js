    ...
    return {
        ...
        preload: function () {
            ...
            game.load.setPreloadSprite(preloadBar);
						game.load.spritesheet("cards", "assets/cards.png", 334, 440);
            ...
            game.load.image('titlePage', 'assets/title.png');
						game.load.image('dealing', 'assets/dealing.png');
            ...
            game.load.audio('titleMusic', ['assets/ACTitle.mp3']);
						game.load.audio('chaching', ['assets/chaching.mp3']);
						game.load.audio('chips', ['assets/chips.mp3']);
						game.load.audio('winSong', ['assets/money.mp3']);
						game.load.audio('lossSong', ['assets/inmydreams.mp3']);
