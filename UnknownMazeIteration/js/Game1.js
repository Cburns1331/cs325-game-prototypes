...
GameStates.makeGame1 = function( game, shared ) {
    ...
    return {
        ...
        create: function () {
          game.world.setBounds(0,0,800,1056);
          game.physics.startSystem(Phaser.Physics.ARCADE);
          map = game.add.tilemap('maze1');
          map.addTilesetImage('tiles', 'tiles');
          map.fixedToCamera = true;

          gameMusic = game.add.audio('OST');
          gameMusic.loop = true;
          gameMusic.play();
          ...
          lostMen.create(96, 286, 'man');
          lostMen.create(352, 608, 'man');
          lostMen.create(576, 992, 'man');
          ...
          level = game.add.sprite(0,0,'lvl1');
        ...
        update: function () {
          render();
          if(ship.x >= 736 && ship.y >= 992 && menFound == 3){
            //music.stop();
            menFound=0;
            endGame(1);
          }
